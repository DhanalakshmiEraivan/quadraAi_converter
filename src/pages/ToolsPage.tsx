...
import { Search, Sparkles, ArrowRight, ChevronRight, X, Zap, ShieldCheck, Clock, Star } from 'lucide-react';
      ...
      <div className="container-page py-10" ref={containerRef}>
        ...
        <div className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <FeatureCard
            ...
            desc="No waiting for uploads or server processing. Results appear immediately."
          />
          <FeatureCard
            icon={Sparkles}
            title="AI-Powered"
